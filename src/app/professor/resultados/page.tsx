      ...
      <header className="bg-white border-b px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-3 items-center">
          <button
            ...
            className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-xl transition disabled:opacity-50"
          >
            ⬇️ Exportar Excel
          </button>
        ...
        {provas.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-2xl border">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Corrija folhas de
              resposta para ver os
              resultados aqui
            </p>

            <a
              href="/professor/provas"
              className="inline-block mt-4 px-4 py-2 bg-indigo-600 text-white rounded-xl text-sm"
            >
              Ir para Provas
            </a>
          </div>
                              ...
                              (
                                ...
                                >
                                  ...
                                  <td className="px-5 py-3 text-center">
                                    <span
                                      className={`inline-block px-3 py-1 rounded-full font-bold border text-sm ${bgNota(
                                        r.nota
                                      )} ${corNota(
                                        r.nota
                                      )}`}
