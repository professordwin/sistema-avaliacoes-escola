...
export default function CoordenadorDashboard() {
  ...
  const [filtro, setFiltro] =
    useState<Filtro>('aguardando')

  const [aba, setAba] =
    useState<Aba>('provas')

  const [provaAberta, setProvaAberta] =
  ...
  const carregar = useCallback(async () => {
    try {
      ...
      const [provasRes, resultadosRes] =
        await Promise.all([
          fetch('/api/coordenador/provas'),
          fetch('/api/coordenador/resultados'),
        ])

      if (!provasRes.ok || !resultadosRes.ok) {
        throw new Error(
      ...
      setProvas(
        Array.isArray(provasData)
          ? provasData
          : []
      )

      setResultados(
        Array.isArray(resultadosData)
          ? resultadosData
          : []
      )
    } catch (err) {
  ...
  async function agir(
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          'Falha ao atualizar prova.'
        )
      }

      setSucesso(
        acao === 'aprovar'
          ? 'Prova aprovada com sucesso.'
          : 'Prova devolvida ao professor.'
      )
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-500">
            Gerencie aprovações, acompanhe
            desempenho acadêmico e supervise
            avaliações.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
          ...
          <ResumoCard
            titulo="Provas aprovadas"
            valor={aprovadas}
            cor="text-green-600"
          />

          <ResumoCard
            titulo="Folhas corrigidas"
            valor={totalCorrigidos}
            cor="text-blue-600"
          />

          <ResumoCard
            titulo="Alunos aprovados"
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      ...
                      {p.status ===
                        ...
                        <button
                          ...
                          className="
                            px-5 py-2.5 bg-purple-600 hover:bg-purple-700
                              ...
                              .map(
                                (r, i) => (
                                  ...
                                  >
                                    ...
                                    <td className="px-5 py-3 text-center font-medium text-green-600">
                                      {
                                        r.acertos
                                      }
                                    </td>
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  disabled={carregando}
                  className="
                    flex-1 py-3 rounded-2xl border-2 border-red-300
